...
s3_path = 'manuscript/sup_figs/promisc15to20/replicates/'
s3_region = 'us-west-1'
...
for i, color in enumerate(colors):
    colordict['PROMISC{0}'.format(15+i)] = color
...
figure_basename = 'promiscN_fitness_traces.svg'
...
s3_path = 'manuscript/sup_figs/promisc15to20/contours/'
filenames = [
    dict['Key'] for dict in s3.list_objects_v2(
        Bucket=bucketname,
        Prefix=s3_path,
...
N_0 = list(set(DF.loc[DF['code'] == 'PROMISC20']['N_0']))
N_0.sort()
